...
function init() {
    ...
    $('#setMaxSell').click(function() {
        ...
        FNB.allInfoFor.call(account, function(error, info) {
            if (!error) {
                var balance = parseFloat(web3.fromWei(info[7], 'ether').toFixed(2));
            }else {
                console.log(error);
            }
